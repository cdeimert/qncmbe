...
# Path to the datafile. Might need to adjust this depending how you run your
# python code.
filepath = 'examples\\refl_fit\\G0641_IS4K Refl.txt'

# If your computer has access to \\insitu1.nexus.uwaterloo.ca
# use the following to pull real-time reflectance data directly from the ZW-XP1
# computer
#
# growth = 'G0641'
...
# However, this way is useful if you're in the middle of a growth and the data
# file is always being updated.
# Using a file link ensures that whenever you call functions to calculate fits
# later, it will use the most up-to-date data
...
# Need to tell it the material, material_beneath, growth rate, and where it
# lies in the reflectance data
#
# Note1: if "t_end" is beyond the end of the data, it will just use up to the
#     end of the data
# Note2: material_beneath is just used to set the initial guess of the ns, ks
#     in the fit. Can be set to "None", but fit is less likely to succeed.
...
# It will do a separate fit for n = 0,1,2... until it reaches the end of the 
# layer. This way you can see how the fitted value (growth rate, in this case)
# converges to some final value.
